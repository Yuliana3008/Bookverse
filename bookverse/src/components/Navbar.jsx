...
const NavItem = ({ item, onClick, isCurrentPage }) => {
  ...
  const commonClasses =
    "text-stone-600 font-medium hover:text-amber-700 transition duration-150 flex items-center group";
  const iconClasses =
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-stone-800 font-serif">
                    Hola, {userName}
                  </span>
                </button>
