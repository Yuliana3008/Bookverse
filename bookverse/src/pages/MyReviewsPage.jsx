...
const MyReviewCard = ({ review }) => {
  ...
  const getGenreDetails = (categoria) => {
    ...
    const config = {
      terror: {
        style:
          "bg-red-100 text-red-800 border-red-200 shadow-[0_0_8px_rgba(153,27,27,0.2)]",
        icon: <Ghost className="w-3 h-3" />,
      },
      romance: {
        style:
          "bg-rose-100 text-rose-800 border-rose-200 shadow-[0_0_8px_rgba(157,23,77,0.2)]",
        icon: <Heart className="w-3 h-3" />,
      },
      suspenso: {
        style:
          "bg-slate-200 text-slate-800 border-slate-300 shadow-[0_0_8px_rgba(30,41,59,0.2)]",
        icon: <Search className="w-3 h-3" />,
      },
      "fantasía": {
        style:
          "bg-purple-100 text-purple-800 border-purple-200 shadow-[0_0_8px_rgba(107,33,168,0.2)]",
      ...
      "ciencia ficción": {
        style:
          "bg-cyan-100 text-cyan-800 border-cyan-200 shadow-[0_0_8px_rgba(21,94,117,0.2)]",
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-[#fdfcf8] border border-dashed border-stone-400 rounded-lg">
            <p className="text-stone-500 font-serif italic text-lg mb-6">
              Aún no has escrito ninguna crónica literaria.
            </p>
            <Link
              to="/add-review"
              className="bg-stone-800 text-white px-6 py-2 uppercase font-black tracking-widest hover:bg-amber-900 transition-colors"
            >
